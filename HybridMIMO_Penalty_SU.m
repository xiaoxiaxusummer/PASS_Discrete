function [F, D, obj] =  HybridMIMO_Penalty_SU(K, M, N, L, H_herm, gamma_min, sigma2, subconnected)
rho = 0.05;
...
for t = 1:Tmax
    for i = 1:BCD_itermax
        W = optimize_W_HybridMIMO_SU(K, M, F, D, H_herm, rho, lambda_W, gamma_min, sigma2);
        F = optimize_F_HybridMIMO(K, N, M, W, F, D, lambda_W, rho, subconnected);
        D = optimize_D_HybridMIMO_SU(K, N, W, F, lambda_W, rho, H_herm, sigma2, gamma_min);
